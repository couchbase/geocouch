...
test_traverse() ->
    ...
    etap:is(lists:sort(?MOD:traverse(Vtree1, [Vtree1#vtree.root], Boxes1, [])),
    ...
    etap:is(lists:sort(?MOD:traverse(Vtree1, [Vtree1#vtree.root], Boxes2, [])),
    ...
    etap:is(lists:sort(?MOD:traverse(Vtree2, [Vtree2#vtree.root], Boxes1, [])),
            lists:sort(Expected3),
            "Traversing tree (137 items) with one box was correct"),

    Expected4 = ExpectedFun(Nodes2, Boxes),
    etap:is(lists:sort(?MOD:traverse(Vtree2, [Vtree2#vtree.root], Boxes, [])),
            lists:sort(Expected4),
    ...
    etap:is(lists:sort(?MOD:traverse(Vtree3, [Vtree3#vtree.root], Boxes1, [])),
            lists:sort(Expected5),
            "Traversing tree (4 items) with one box was correct"),

    Expected6 = ExpectedFun(Nodes3, Boxes),
    etap:is(lists:sort(?MOD:traverse(Vtree3, [Vtree3#vtree.root], Boxes, [])),
            lists:sort(Expected6),
